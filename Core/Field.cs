...
public partial class Field
{
    ...
    public static int CoordinateDistance(Field field1, Field field2)
    {
        return Coordinates.Distance(field1.coordinates, field2.coordinates);
    }

    public static bool SameCoordinates(Field field1, Field field2)
    {
        return Coordinates.IsEqual(field1.coordinates, field2.coordinates);
    }
...
public partial class Field
{
    public class Coordinates
    {
        ...
        public static bool IsEqual(Coordinates cor1, Coordinates cor2)
        {
            if (cor1.i == cor2.i && cor2.j == cor1.j) return true;
            return false;
        }

        public static Coordinates operator +(Coordinates c1, Coordinates c2)
        {
            return new Coordinates(c1.i + c2.i, c1.j + c2.j);
        }
        public static Coordinates operator -(Coordinates c1, Coordinates c2)
        {
            return new Coordinates(c1.i - c2.i, c1.j - c2.j);
        ...
        {
            int di = Mathf.Abs(c1.i - c2.i);
            int dj = Mathf.Abs(c1.j - c2.j);
            return Mathf.Max(di, dj);
        }
